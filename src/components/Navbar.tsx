        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
            ...
            {navLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  className={`relative px-3.5 py-2 rounded-lg text-[13px] font-semibold tracking-tight transition-all duration-200 ${
                    isActive
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden xl:flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#E2E4F0] bg-[#F8F9FD] text-[11px] font-semibold text-[#525875]">
              ...
              <span className="text-amber-600 font-bold">· 8 places</span>
            </div>
        ...
        >
          <div className="px-5 pt-4 pb-6 space-y-1">
            ...
            <div className="flex items-center gap-2 px-4 py-3 mb-3 rounded-xl bg-[#F8F9FD] border border-[#E2E4F0]">
              ...
              <span className="ml-auto text-xs font-bold text-amber-600">8 places restantes</span>
            </div>
