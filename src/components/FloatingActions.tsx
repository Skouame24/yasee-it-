...
export default function FloatingActions({ onOpenModal }: FloatingActionsProps) {
  return (
    <div className="fixed right-4 bottom-6 z-40 select-none">
      ...
      <a
        href="https://wa.me/2250711444588?text=Bonjour%20YASEE%20IT%2C%20je%20souhaite%20des%20informations%20sur%20la%20formation%20ISO%2027001%20Lead%20Implementer."
        target="_blank"
